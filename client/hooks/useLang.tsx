...
const dict: Dictionary = {
  ...
  joinGroup: {
    EN: "Join Group Consultation",
    HI: "ग्रुप कंसल्टेशन में जुड़ें",
    PA: "ਗਰੁੱਪ ਕਨਸਲਟੇਸ਼ਨ ਵਿਚ ਸ਼ਾਮਲ ਹੋਵੋ",
  },
  estWait: {
    EN: "Estimated wait",
    HI: "अनुमानित प्रतीक्षा",
    PA: "ਅੰਦਾਜ਼ੇ ਦਾ ਇੰਤਜ਼ਾਰ",
  },
  ...
  noRooms: {
    EN: "No active rooms",
    HI: "कोई सक्रिय रूम नहीं",
    PA: "ਕੋਈ ਸਰਗਰਮ ਰੂਮ ਨਹੀਂ",
  },
  doctorAppointed: {
    EN: "Doctor appointed",
    HI: "डॉक्टर नियुक्त",
